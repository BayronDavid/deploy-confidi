                            ...
                            <div key={prop.id} className="option-grid__row">
                                ...
                                <div className="option-grid__column epift-col-proprietario">
                                    <CustomSelector
                                        ...
                                        onChange={(val) => handleChangeField(prop.id, "proprietario", val)}
                                        width="100%"
                                        floatingOptions
                                    />
                                </div>
                                ...
                                <div className="option-grid__column epift-col-tipologia">
                                    <CustomSelector
                                        ...
                                        onChange={(val) => handleChangeField(prop.id, "tipologia", val)}
                                        width="100%"
                                        floatingOptions
                                    />
                                </div>
                                ...
                                <div className="option-grid__column epift-col-gravami">
                                    <CustomSelector
                                        ...
                                        value={prop.gravami}
                                        onChange={(val) => handleChangeField(prop.id, "gravami", val)}
                                        width="100%"
                                        floatingOptions
                                    />
                                </div>
                                ...
                                <div className="option-grid__column epift-col-remove">
                                    {prop.nonRemovable ? (
                                        // No renderizamos el botón si es no eliminable
                                        null
                                    ) : (
                                        <button
                                            type="button"
