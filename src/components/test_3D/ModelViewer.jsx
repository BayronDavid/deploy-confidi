    ...
    const findTextures = (obj) => {
      ...
      if (obj.material) {
        ...
        for (const prop in material) {
          if (material[prop] && material[prop] instanceof THREE.Texture && !['map', 'normalMap', 'roughnessMap', 'metalnessMap', 'aoMap', 'emissiveMap', 'specularMap', 'bumpMap', 'displacementMap'].includes(prop)) {
