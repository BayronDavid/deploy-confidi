...
const formConfig = {
    ...
    groups: [
        ...
        },
        {
            ...
            inputs: [
                {
                    id: "DatiImpresaRichiedente",
                    type: "DynamicInputGrid",
                    required: true,
                    warningMessage: "È necessario compilare i dati dell'impresa richiedente",
                    allowMultiple: false,
                    allowAddRows: false,
                    columns: [
                        {
                            id: "denominazione_cf",
                            title: "Denominazione e C.F. Impresa",
                            type: "text",
                            fieldName: "denominazione_cf",
                            width: "20%",
                        ...
                        },
                        {
                            ...
                            type: "computed",
                            fieldName: "totaleFatturato",
                            width: "15%",
                            compute: function (rowData) {
                                const f1 = parseFloat(rowData.fatturato?.fatturatoAnno1 || 0);
                                const f2 = parseFloat(rowData.fatturato?.fatturatoAnno2 || 0);
                                const sum = f1 + f2;
                                return sum ? `${sum} (k€)` : "";
                            }
                        },
                        {
                            ...
                            title: "Totale Attivo",
                            type: "computed",
                            fieldName: "totaleAttivo",
                            width: "15%",
                            compute: function (rowData) {
                                const a1 = parseFloat(rowData.attivo?.attivoAnno1 || 0);
                                const a2 = parseFloat(rowData.attivo?.attivoAnno2 || 0);
                                const sum = a1 + a2;
                                return sum ? `${sum} (k€)` : "";
                            }
                        }
